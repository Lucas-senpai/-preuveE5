                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Nous avons <strong class="text-brand">{{$products->total()}}</strong> produit pour vous !</p>
                            </div>
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            {{--Si orderby est default alors c'est active sinon rien--}}
                                            ...
                                            <li><a class="{{ $orderBy=='Nouveautées' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Nouveautées')">Nouveautées</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

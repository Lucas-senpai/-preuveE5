                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Nous avons <strong class="text-brand">{{$products->total()}}</strong> produits correspondant à la recherche</p>
                            </div>
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy=='Défault' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Défault')">Défaut</a></li>
                                            <li><a class="{{ $orderBy=='Prix: croissant' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Prix: croissant')">Prix: croissants</a></li>
                                            <li><a class="{{ $orderBy=='Prix: décroissant' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Prix: décroissant')">Prix: décroissants</a></li>
